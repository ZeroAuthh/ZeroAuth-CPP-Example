...
#define NOTIFY_PADDING_Y				0.f		// Bottom-left Y padding
...
enum ImGuiToastType_
{
	...
	ImGuiToastType_Disconnect,
	ImGuiToastType_IM,
	ImGuiToastType_OOB,
	ImGuiToastType_Status,
	ImGuiToastType_Friends,
	...
	NOTIFY_INLINE auto get_default_title() -> const char*
	{
		if (!strlen(this->title))
		{
			...
			case ImGuiToastType_Info:
				return (char*)"Info";
			case ImGuiToastType_Disconnect:
				return (char*)"Disconnect";
			case ImGuiToastType_IM:
				return (char*)"Instant Message";
			case ImGuiToastType_OOB:
				return (char*)"OOB";
			case ImGuiToastType_Status:
				return (char*)"Status";
			case ImGuiToastType_Friends:
				return (char*)"Added Friend";
			}
		}
...
namespace ImGui
{
	...
	NOTIFY_INLINE VOID RenderNotifications()
	{
		...
		vp res = { desktop.right, desktop.bottom };
		...
		for (auto i = 0; i < notifications.size(); i++)
		{
			...
			SetNextWindowPos(ImVec2(vp_size.x - NOTIFY_PADDING_X, vp_size.y - NOTIFY_PADDING_Y - height), ImGuiCond_Always, ImVec2(1.0f, 2.2f));
