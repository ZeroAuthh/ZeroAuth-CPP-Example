...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonClout(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          ButtonAnimado14(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          ButtonAnimado12(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          ButtonAnimado9(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
